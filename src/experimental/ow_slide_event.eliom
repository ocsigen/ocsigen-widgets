...
[%%client
  ...
  let get_slide_coord ?t_type idx ?p_type = function
    | Touch_event ev    ->
      Ow_event_tools.get_touch_ev_coord ?t_type idx ?p_type ev
    | Mouse_event ev    ->
      Ow_event_tools.get_mouse_ev_coord ?p_type ev

  let get_local_slide_coord dom_elt ?t_type idx ?p_type = function
    | Touch_event ev    ->
      Ow_event_tools.get_local_touch_ev_coord dom_elt ?t_type idx ?p_type ev
    | Mouse_event ev    ->
      Ow_event_tools.get_local_mouse_ev_coord dom_elt ?p_type ev
